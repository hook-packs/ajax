(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.HookAjax = factory(global.axios));
	...
	*/
	...
	var Callback = /*#__PURE__*/function () {
	  function Callback() {
	    _classCallCheck$1(this, Callback);

	    this[itemsSymbol] = [];
	    this[groupsSymbol] = {};
	  }

	  _createClass$1(Callback, [{
	    key: "configGroup",
	    ...
	    value: function value() {
	      ...
	      return sortBy_1(arr, [function (item) {
	...
	var Event = /*#__PURE__*/function () {
	  ...
	  _createClass$2(Event, [{
	    ...
	    value: function configEventGroups(eventName) {
	      ...
	      Object.keys(groups).concat(Object.getOwnPropertySymbols(groups)).forEach(function (group) {
	        ...
	        if (Array.isArray(item)) {
	          var _item = _slicedToArray$1(item, 2),
	              order = _item[0],
	              _item$ = _item[1],
	    ...
	    key: "emit",
	    value: function () {
	      var _emit = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee(eventInfo) {
	    ...
	    value: function value(eventName) {
	      if (!this.hookCallbacks[eventName]) {
	        this.hookCallbacks[eventName] = new Callback();
	      }
	    ...
	    value: function () {
	      var _value = _asyncToGenerator$1( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
	        var items,
	            item,
	            executed,
	            count,
	...
	var symbolsSymbol = Symbol("symbols");

	var HookBase = /*#__PURE__*/function (_HookEvent) {
	  _inherits$1(HookBase, _HookEvent);

	  var _super = _createSuper$1(HookBase);

	  function HookBase() {
	    var _this;

	    _classCallCheck$3(this, HookBase);

	    _this = _super.call(this);
	    _this[symbolsSymbol] = {};

	    _this.addSetAndGetMethods("set", "get");

	    return _this;
	  }

	  _createClass$3(HookBase, [{
	    key: "getSameSymbol",
	    value: function getSameSymbol(key) {
	      if (!this[symbolsSymbol][key]) {
	        this[symbolsSymbol][key] = Symbol(key);
	      }

	      return this[symbolsSymbol][key];
	    }
	  }, {
	    key: "addSetAndGetMethods",
	    value: function addSetAndGetMethods(setName, getName, props) {
	      var _this2 = this;

	      var datas = {};
	      this.setReadOnlyProps(setName, props);
	      var propsSymbol = this.getSameSymbol(setName);

	      this[setName] = function (key, value) {
	        var readOnlys = _this2[propsSymbol] || {};
	    ...
	    value: function setReadOnlyProps(setName) {
	      var props = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
	      var propsSymbol = this.getSameSymbol(setName);
	      var readOnlys = this[propsSymbol] = this[propsSymbol] || {};
	      Object.keys(props).forEach(function (key) {
	        if (props[key]) {
	          readOnlys[key] = true;
	        } else {
	          delete readOnlys[key];
	        }
	      });
	      this.emit("HOOKLOG", {
	        code: 200001,
	    ...
	    key: "rewrite",
	    value: function rewrite(name, method) {
	      this[name] = method;
	      return this;
	    }
	  }]);
